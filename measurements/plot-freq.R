...
dataAsm <- read.csv("./asm/raw-freq.csv", header=FALSE)
dataLlvm <- read.csv("./llvm/raw-freq.csv", header=FALSE)
dataAsmLess <- read.csv("./asm-less-opt/raw-freq.csv", header=FALSE)
